...
module.exports =
	...
	function NotesApplication () {
		...
		this.notes = []; // an array for holding different notes
		
/* 
	this method adds a note object to note array
*/
		this.addNote = function (note) {
			
			this.notes.push(note); // appends a new note to the end of a note
				
		};
		
/*
	this method returns a list of all notes
*/
